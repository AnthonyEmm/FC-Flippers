  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-50">
      ...
      <div className="w-full max-w-3xl bg-white p-6 sm:p-8 mt-4 rounded-lg shadow-md font-custom relative">
        ...
        <p className="text-gray-700 text-left mb-4 font-semibold text-sm sm:text-sm">
          <i>{t("womenloss.photo")}</i>
        </p>
        <p className="text-black text-left mb-4 font-semibold text-sm sm:text-lg">
          {t("womenloss.secondGame")}
        </p>
        {/* New Image Section */}
        <div className="mb-2">
          <img
            src="/women-match2.jpg"
            alt="Match Highlights"
            className="w-full h-auto object-cover"
          />
        </div>
        ...
        <p className="text-black text-left mb-4 font-semibold text-sm sm:text-lg">
          {t("womenloss.thirdGame")}
        </p>
        <p className="text-black text-left mb-4 font-semibold text-sm sm:text-lg">
          {t("womenloss.closing")}
        </p>
        <p className="text-gray-700 mb-2 font-bold text-lg sm:text-xl md:text-2xl lg:text-xl text-left">
          <i>{t("womenloss.comment")}</i>
        </p>
        <p className="text-gray-700 mb-6 font-bold text-sm sm:text-md md:text-base lg:text-md text-left">
          - <i>{t("womenloss.womenCoach")}</i>
        </p>
        <p className="text-black text-right mt-24 font-semibold text-sm sm:text-sm italic">
          {t("womenloss.NewsBy")}
        </p>
      </div>
