    ...
    <div className="w-full py-8 px-4 md:px-8 font-custom bg-blue-50">
      ...
      <div className="flex justify-end items-center relative">
        ...
        <div className="relative">
          ...
          {searchTerm && isSearchOpen && (
            <FiX
              className="absolute right-3 top-1 md:top-2 cursor-pointer
      ...
      {filteredPlayers.length === 0 && searchTerm && (
        <div className="flex justify-center items-center mt-10">
          <div className="text-center text-red-600 text-xl md:text-xl font-semibold uppercase">
            {t("search.noResults")}
          </div>
        </div>
      )}
      ...
      <div
       ...
       gap-6 md:gap-8 cursor-pointer mt-4"
      >
        {loading
              ...
              >
                <div className="relative overflow-hidden">
                  <img
                    src={player.image}
                    alt={player.name}
                    className="w-full h-80 md:h-80 object-cover transform 
