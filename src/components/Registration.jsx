  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-50">
      ...
      <div className="relative w-full h-72 sm:h-96 md:h-[40vh] lg:h-screen">
        ...
        <div
          className="absolute bottom-14 sm:bottom-18 md:bottom-20 
        left-1/2 transform -translate-x-1/2 font-custom hidden lg:block"
        >
          <div
      ...
      <div className="w-full max-w-3xl bg-white p-6 sm:p-8 mt-4 rounded-lg shadow-md font-custom">
        ...
        <p className="text-gray-700 text-left mt-4 sm:mt-8 mb-4 font-semibold text-xs sm:text-sm">
          <i>{t("registration.articleDate")}</i>
        </p>
        ...
        <p className="text-black text-left mb-6 font-semibold text-sm sm:text-lg">
          {t("registration.focus")}
        </p>
        <p className="text-black text-left mb-6 font-semibold text-sm sm:text-lg">
          {t("registration.coaches")}
        </p>
        <p className="text-gray-700 text-left mb-2 font-bold text-lg sm:text-2xl">
          <i>{t("registration.quote")}</i>
        </p>
        <p className="text-gray-700 text-left mb-6 font-bold text-xs sm:text-sm">
          <i>{t("registration.director")}</i>
        </p>
        {/* New Image Section */}
        <div className="mb-1">
          <img
            src="/academy-coaching.jpeg"
            alt="academy training session"
            className="w-full h-auto object-cover"
          />
        </div>
        <p className="text-gray-700 text-left mb-6 font-semibold text-sm sm:text-sm">
          <i>{t("registration.photo")}</i>
        </p>
        <p className="text-black text-left mb-6 font-semibold text-sm sm:text-lg">
          {t("registration.registrationDetails")}
        </p>
        <p className="text-black text-left mb-16 font-semibold text-sm sm:text-lg">
          {t("registration.welcomeBack")}
        </p>
        <p className="text-gray-700 text-right mt-8 font-semibold text-xs sm:text-md">
          <i>{t("registration.signedBy")}</i>
        </p>
      </div>
